...
<a href="confirm?cartId=${cart.id}" button type="button" class="btn btn-primary btn-lg">>>Check out for delivery</button>
</br>
<a href="newQuote/${cart.id}" button type="button" class="btn btn-secondary btn-lg">>>Click here to Quote a desired amount in Rs</button>
